...
// 2. extrar todas las cuentas de facebook
const facebokAccounts = [];
facebokAccounts.push(users[0].social[0]);
facebokAccounts.push(users[1].social[0]);
facebokAccounts.push(users[2].social[0]);
facebokAccounts.push(users[3].social[0]);
facebokAccounts.push(users[4].social[0]);
console.log(facebokAccounts);

// Almacenar en un arreglo nuevo las url de facebook
const facebookUrls = [];
